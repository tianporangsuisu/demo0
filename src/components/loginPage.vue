<template>
  <div class="login">
    <div style="margin: auto auto;font-size: xx-large;font-style: italic">
      登陆界面
      <br>
      <el-input placeholder="账号" v-model="account" class="input"></el-input>
      <br>
      <el-input placeholder="密码" show-password v-model="password" class="input"></el-input>
      <br>
